            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "fund raised from \$${campaign.amount.toInt()}",
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Raised \$${campaign.currentAmount.toInt()}",
                        style: TextStyle(
                  ...
                  SizedBox(height: 12),
                  if (campaign.story != null && campaign.story!.isNotEmpty)
                    Text(
                      campaign.story!,
                      style: TextStyle(
                        fontSize: 14,
                  ...
                  SizedBox(height: 16),
                  if (campaign.imageUrl1 != null && campaign.imageUrl1!.isNotEmpty)
                    Container(
                      width: double.infinity,
                      height: 200,
                      decoration: BoxDecoration(
